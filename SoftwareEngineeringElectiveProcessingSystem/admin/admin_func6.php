...
<?php
  if(isset($_POST['submit']))
  {
    ...
    $sql_insert = 
      "INSERT INTO Student(studentName,programId,rollNo,yearOfJoining,Addr,Phone)
          VALUES ('$studentName','$programId','$rollNo','$yearOfJoining','$Addr','$Phone')";
          
        if(mysqli_query($conn,$sql_insert))
      {
          echo '<script>alert("Student record added sucessfully")</script>';
      }
      else{
...
<center>
  ...
  <input type="text" name="yearOfJoining" required><br>
  <label>Address :</label>
